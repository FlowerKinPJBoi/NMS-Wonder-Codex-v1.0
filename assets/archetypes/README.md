...
1. An approved primary screenshot.
2. A supported fauna family selected from an approved exact pet/discovery match or an unambiguous confirmed VP1 mapping.
...
Asset placeholders are original Wonder Codex schematic illustrations. They are not derived from third-party creature or asset builders and must be labeled “Illustrative reconstruction — not an image of this exact specimen” in the asset catalog.
