(() => {
  ...
  const TEST_GUIDES = {
    ...
    'capture-companion': {
      ...
      intro: 'Validate guided discovery-to-screenshot pairing and explicit private review submission without modifying a save or injecting into No Man’s Sky. Nothing is uploaded or published automatically.',
      steps: [
        ...
        'Choose Steam F12, Xbox Game Bar, Windows Snipping Tool, or Other as the screenshot method. Confirm or correct the suggested screenshot folder.',
        'Choose whether Capture Companion should prompt or open that screenshot helper after each NMSpy scan. Steam F12 remains an in-game key prompt; Game Bar and Snipping Tool may be opened by Windows.',
        'Select Start capture watch before scanning a new discovery in game.',
        'Scan one new discovery. Follow the helper prompt, take one clear specimen screenshot immediately, and return to Capture Companion.',
        'Compare discovery type/name, character, timing, and image before confirming the proposed pair.',
        ...
        'Authorize with the tester’s own named app credential and explicitly submit one confirmed non-excluded pair. Confirm the app reports that it is queued for private owner review—not publicly published.',
      ],
      screenshots: [
        'App header/version and the read-only safety boundary.',
        'Selected character, screenshot-method choice, helper setting, and screenshot-folder state, with personal path portions redacted.',
        ...
        'The successful queued-for-owner-review result for the submitted test pair.',
        'Every warning, mismatch, or error with its full exact message.',
      ],
      files: [
        'The screenshots listed above.',
        'This downloaded text report, completed with platform, screenshot helper, pairing, exclusion, and private-queue results.',
      ...
      stop: [
        ...
        'Stop if the app requests administrator rights, modifies a save, injects into the game, reads process memory, or uploads before explicit tester confirmation.',
      ...
      report: [
        ...
        'Windows version:',
        'Local save source: Steam / Xbox-Game Pass PC',
        'Screenshot method / helper / folder type:',
        'Character detected and selected correctly: Yes / No',
        'Screenshot helper opened or prompted as selected: Yes / No',
        ...
        'Confirmed pair queued for private owner review: Yes / No',
        'Pair appeared publicly without owner approval: Yes / No',
