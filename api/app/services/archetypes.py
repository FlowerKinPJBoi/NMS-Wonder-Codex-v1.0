...
SUPPORTED_FAUNA_ARCHETYPES = {
    ...
    "FLYINGLIZARD": ("fauna.flyinglizard", "Flying reptile"),
    ...
    "WEIRDBUTTERFLY": ("fauna.weirdbutterfly", "Exotic winged fauna"),
