...
assert.match(page, /Neither path can teach production Daedalus until an authorized reviewer approves and separately releases/i);
...
assert.match(shared, /window\.DaedalusShared = \{submitLearningBlob, refreshQueue: connect\}/);
